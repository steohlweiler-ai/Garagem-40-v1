...
const App: React.FC = () => {
    ...
    // TEMPORARILY DISABLED to isolate AbortError issue
    // TODO: Re-enable after fixing AbortController logic
    /*
    ...
    */
    ...
    const loadServices = async (reset: boolean = false) => {
        ...
        // TEMPORARILY REMOVED AbortController to isolate AbortError issue
        ...
        try {
            ...
            const result = await dataProvider.getServicesFiltered({
                ...
                offset,
                sortBy: 'priority'
                // signal: controller.signal // TEMPORARILY REMOVED
            });
            ...
            // clearTimeout(timeout); // TEMPORARILY REMOVED
            if (loadingServicesTimeoutRef.current) clearTimeout(loadingServicesTimeoutRef.current);
