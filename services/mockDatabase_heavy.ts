...
class MockDBHeavy {
    ...
    private generateHeavyData() {
        ...
        return {
            ...
            users: [{ id: 'u1', name: 'Tester', email: 'test@g40.com', phone: '', role: 'admin', active: true, permissions: { access_clients: true, view_values_execution: true, view_values_reports: true, create_templates: true, manage_reminders: true }, created_at: '' }] as UserAccount[],
            statusConfigs: [],
