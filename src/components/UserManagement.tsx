...
const UserManagement: React.FC<UserManagementProps> = ({ currentUser }) => {
  ...
  const handleOpenModal = (user?: UserAccount) => {
    ...
    if (user) {
      ...
      // Safe merging of permissions
      const basePermissions = { ...INITIAL_PERMS };
      const userPermissions = user.permissions || {};
      const presetPermissions = ROLE_PRESETS[user.role] || {};
      ...
      setFormData({
        ...
        role: user.role,
        active: user.active,
        permissions: effectivePermissions as UserPermissions,
            ...
            <div className="flex gap-4 items-center w-full sm:w-auto">
              ...
              <div className="text-left">
                ...
                <div className="flex gap-2 mt-2">
                  <span className="text-[8px] font-black uppercase px-2 py-0.5 border rounded bg-slate-50 text-slate-400">{user.role}</span>
                  {user.active ? (
