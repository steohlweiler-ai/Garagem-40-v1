  ...
  constructor() {
    ...
    if (saved) {
      ...
      this.data = {
        ...
        users: [{ id: 'u1', name: 'Admin Master', email: 'admin@garagem40.com.br', phone: '', role: 'admin', active: true, permissions: { manage_team: true, manage_clients: true, manage_inventory: true, config_rates: true, config_vehicles: true, config_system: true, view_financials: true }, created_at: '', organization_id: 'org_1' }],
        statusConfigs: [],
